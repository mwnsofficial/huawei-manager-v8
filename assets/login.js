...
msg("Login Error");
msg("Not Connected To The Router");
}
}
});
}
...
$("#rsrqtr8").css('display','none');
$("#callseting").css('display','none');
msg("Skip Attempts To Enter, Try Again In 2 Minutes");
getSeason();
Main();
...
$("#rsrqtr8").css('display','none');
$("#callseting").css('display','none');
msg("There Is A User Inside Try After 2 Minutes Or Do A Restart");
getSeason();
Main();
